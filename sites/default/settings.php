...
/*
	if you want to load a master file/sku 
	update more than 4k items please set max execution time to 0 then it will be like this [ini_set('max_execution_time', 0);]
	after done set it to 120
 ...
 *
 */
$drupal_hash_salt = 'LN-fF2hyiYpfwkDWmZShKn8dDZWQBiIQbb5XPwzhgwo';
